...
public class MVVKPSPublicSoap
{
    ...
    public MVVKPSPublicSoap(){}

    public MVVKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public MVVKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        MVVExtendedSoapSerializationEnvelope envelope= new MVVExtendedSoapSerializationEnvelope(MVVExtendedSoapSerializationEnvelope.VER11);
