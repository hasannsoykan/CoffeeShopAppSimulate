...
public class MVVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(MVVDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new MVVStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static MVVDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static MVVDateTimeConverter dateTimeConverter = new MVVStandardDateTimeConverter();

    public MVVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public MVVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new MVVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=MVVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public SoapObject GetSoapObject(Element detailElement) {
        ...
        catch (java.lang.Exception e)
        {
			if(enableLogging)
			{
				android.util.Log.e(MVVExtendedSoapSerializationEnvelope.TAG,"Error occured",e);
			}
        }
        return null;
    }
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,MVVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=MVVHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
